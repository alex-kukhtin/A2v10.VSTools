...
internal static class SqlFieldExtensions
{
	...
	private static readonly HashSet<String> _escapeNames =
		[.. "Select,Where,Having,Order,By,Partition,Begin,End,Start,Name,Date,Sum,Avg,Min,Max,Rows,External,File,For,From,To,Group,Case,If,Into,Table,Tran,Union,Update,Insert,Delete,Inner,Outer,Version,Uid,Contract,Role,Money,Message,Level,Source,Target,Sample"
